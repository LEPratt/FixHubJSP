...
public class WebUtils {
	...
	private static final String UPLOADED_FOLDER = "assets" + File.separator + "img";

	public void sendMail(String to, String from, String msg, String subject) {
